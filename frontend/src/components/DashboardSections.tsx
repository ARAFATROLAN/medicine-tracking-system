...
const DashboardSections: React.FC = () => {
  ...
  // ✅ stable function (prevents re-renders)
  const toggle = useCallback((section: string) => {
    setOpen((prev) => (prev === section ? null : section));
  }, []);

  // ✅ memoized chart data (CRITICAL FIX)
  ...
  return (
    <div className="flex flex-col gap-4">
      ...
      <div className="bg-white shadow rounded-lg">
        ...
        {open === "stats" && (
          <div className="p-6 grid grid-cols-1 md:grid-cols-4 gap-4">
            <div className="p-4 rounded shadow">Doctors: 12</div>
            <div className="p-4 rounded shadow">Patients: 250</div>
            <div className="p-4 rounded shadow">Medicines: 340</div>
            <div className="p-4 rounded shadow">Pending Deliveries: 15</div>
          </div>
        )}
      </div>
      ...
      <div className="bg-white shadow rounded-lg">
        ...
        {open === "lowStock" && (
          <ul className="p-6 list-disc pl-6 text-red-700">
